...
### 批次 6 — 多 Agent 协作（仅父子 Agentic / Agentic 工作流）
...
7. 哪些工具的返回可能吃满上下文、兜底方式是否认可——尤其确认没有"估算超 10k 却没有任何兜底"的工具
8. 上限与预算是否可接受
